...
;(function (root, factory) {
  ...
  Ssi_modal.prototype.generateButton = function (buttonOptions, $modalWindow = $(document.body)) {
    var defaults = {
      className: '',
      enableAfter: false,
      method: function () {},
    ...
    if (buttonOptions.keyPress) {
      buttonOptions.keyPress = buttonOptions.keyPress.replace(/(ctrl|shift|alt)[-+]/gi, (_, p1) => {
        buttonOptions[p1.toLowerCase()] = true
        return ''
      }).toLowerCase()
      (buttonOptions.keyPressBody ? $(document.body) : $modalWindow).on('keydown.ssi_modal', function (e) {
