    ...
    function updatePreview(color) {
      ...
      $preview.html(function () {
        return $('<div>', { style: 'display: flex; text-align: center' }).append(
          $('<div>', { style: 'width: 25%; background-color: transparent' }).append(
            $('<span>', { text: color }).css('color', color)
          ),
          $('<div>', { style: 'width: 25%; background-color: #fff' }).append(
            $('<span>', { text: color }).css('color', color)
          ),
          $('<div>', { style: 'width: 25%; background-color: #000' }).append(
            $('<span>', { text: color }).css('color', color)
          ),
